...
from app.memory.merchant_memory import _memory_config, _vector_store_config
...
def test_mem0_runtime_config_declares_the_explicit_shared_provider():
    config = _memory_config()["embedder"]
    assert config == {
        "provider": "shared_bge",
